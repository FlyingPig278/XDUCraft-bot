...
SCRIM = (0, 0, 0, 148)
#: 背景保持暗色但让纹理更清楚；黑色混凝土粉末仍会接受较轻遮罩。
SCRIM_TARGET_LUMINANCE = 0.007
...
# --- 文字层级 ---
INK = (255, 255, 255, 255)
INK_STRONG = (255, 255, 255, 217)
INK_MUTED = (255, 255, 255, 191)
INK_FAINT = (255, 255, 255, 178)
INK_GHOST = (255, 255, 255, 128)
#: 地址与版本使用同一组灰色。
INK_META = (190, 190, 190, 205)
#: 玩家名单是卡片里最低优先级的信息，使用更暗的灰色。
INK_PLAYER = (120, 120, 120, 180)
...
TYPE_TITLE = 30      # 图片主标题；标题行高度不变，只缩小字形以增加上下呼吸
...
MOTD_LINES = 2
RAIL_WIDTH = 156
#: 上下边框使用验证条自身 alpha 的 40%，保证任何情况下都比验证条更透明。
CARD_GRADIENT_ALPHA_RATIO = 0.40
...
#: 金属铭牌式高光：左上角与右下角各画一段渐隐亮边。
TAG_GLINT_LENGTH = 10
TAG_GLINT_WIDTH = 1
TAG_GLINT_COLOR = (255, 255, 255, 185)
...
__all__ = [
    ...
    "INK", "INK_STRONG", "INK_MUTED", "INK_FAINT", "INK_GHOST", "INK_META", "INK_PLAYER", "INK_DARK",
    ...
    "BAND_PADDING_TOP", "BAND_PADDING_BOTTOM", "BAND_NOTICE_HEIGHT", "BAND_CREDIT_HEIGHT", "BAND_LINE_GAP",
    "BAND_VIGNETTE", "BAND_BOTTOM",
    "CARD_HEIGHT", "CARD_GAP", "CARD_PAD", "CARD_COL_GAP", "CARD_GRADIENT_ALPHA_RATIO",
